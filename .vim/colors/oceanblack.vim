...
"hi CursorLine term=none cterm=none ctermbg=darkgray guibg=darkgray
"hi PMenu term=standout ctermfg=black ctermbg=darkgray guifg=black guibg=darkgray
"hi PMenuSel term=standout ctermfg=darkgray ctermbg=black guifg=darkgray guibg=black
